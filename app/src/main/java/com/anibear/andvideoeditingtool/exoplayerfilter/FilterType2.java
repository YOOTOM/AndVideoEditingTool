...
import com.daasuu.epf.filter.GlFilter2;
...
public enum FilterType2 {
    ...
    public static ArrayList<FilterType2> createFilterList() {
        return  new ArrayList<>(Arrays.asList(FilterType2.values()));
    }

    public static GlFilter2 createGlFilter(FilterType2 filterType, Context context) {
        switch (filterType) {
            case DEFAULT:
                return new GlFilter2();
            case BILATERAL_BLUR:
